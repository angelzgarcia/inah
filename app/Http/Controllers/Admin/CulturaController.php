...
use App\Http\Requests\Culturas\StoreCulturaRequest;
use App\Http\Requests\Culturas\UpdateCulturaRequest;
...
class CulturaController extends Controller
{
    ...
    */
     ...
     */
    public function update(UpdateCulturaRequest $request, Cultura $culture)
    {
        // $culture = Cultura::where('idCultura', $id) -> first();
