...
use App\Http\Requests\Estados\StoreEstadoRequest;
use App\Http\Requests\Estados\UpdateEstadoRequest;
...
class EstadoController extends Controller
{
     ...
     */
    public function update(UpdateEstadoRequest $request, Estado $state)
    {
        $state -> nombre = $request -> nombre;
        $state -> capital = $request -> capital;
        $state -> video = $request -> video;
