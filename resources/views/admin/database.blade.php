        ...
        <div class="tables-preview-container">
            ...
            @foreach($tables_and_counts as $table)
                <x-admin.table-preview>
                    {{-- nombre de la tabla --}}
                    <h3>
                        <a href="{{ route('admin.'.Str::lower($table['name'])) }}" :active="request()->roteIs('admin.'.Str::lower($table['name']))" wire:navigate>
                    ...
                    <x-slot name="examinar">
                        <a href="{{ route('admin.'.Str::lower($table['name'])) }}" :active="request()->routeIs('admin.'.Str::lower($table['name']))" wire:navigate>
