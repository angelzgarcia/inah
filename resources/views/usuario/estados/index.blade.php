...
<x-user-main title="Estados de México | INAH">
    ...
    <div class="flex flex-col justify-center text-center gap-8">
        ...
        {{-- mapa de estados --}}
        <section class="w-full flex justify-center items-center" style="height: 67vh">
            <div id="mapEstados" class="h-full rounded-xl shadow-lg w-4/5"></div>
        </section>
    ...
    @push('js')
        <script async src="https://maps.googleapis.com/maps/api/js?key={{config('services.google_maps.key')}}&loading=async&libraries=places&callback=initMap"></script>
