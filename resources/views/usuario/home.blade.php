...
<x-user-main title="Bienvenidos al INAH | Pagina principal">
    <div class="home-container">
        <div class="zonas-home">
            <h2>
                <a href="{{route('zonas.index')}}" :active="request()->routeIs('zonas.index')" wire:navigate>
                    Zonas arqueológicas
                </a>
        ...
        <div class="estados-home">
            <h2>
                <a href="{{route('estados.index')}}" :active="request()->routeIs('estados.index')" wire:navigate>
        ...
        <div class="culturas-home">
            <h2>
                <a href="{{route('culturas.index')}}" :active="request()->routeIs('culturas.index')" wire:navigate>
                    Culturas de México
                </a>
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z"/></svg>
            </h2>
